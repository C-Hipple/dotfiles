...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     ;; For some reason having issues from elpa
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ac-ispell ace-jump-helm-line ace-link ace-window aggressive-indent aider aio
         ...
         clang-format clean-aindent-mode cmm-mode code-cells code-review-server
         column-enforce-mode company-cabal company-lua company-terraform compat
         concurrent counsel counsel-gtags cov csv-mode ctable cython-mode
         dakrone-light-theme dakrone-theme dap-mode dash dash-docs deferred
         define-word devdocs diminish dired-quick-sort docker-compose-mode
         dockerfile-mode doom-themes dotenv-mode drag-stuff dream-theme dumb-jump
         dune editorconfig ef-themes eglot elisp-def elisp-slime-nav elpy emacsql
         ...
         lsp-jedi lsp-mode lsp-origami lsp-python-ms lsp-treemacs lsp-ui lua-mode
         lv macrostep magit magit-popup magit-section markdown-mode markdown-toc
         ...
         yapfify yasnippet yasnippet-snippets zeno-theme zig-mode zig-ts-mode))
