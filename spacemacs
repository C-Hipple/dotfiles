...
(custom-set-faces
 ...
 ;; If there is more than one, they won't work right.
 '(default ((((class color) (min-colors 257)) nil) (((class color) (min-colors 89)) (:background "#1c1c1c" :foreground "#eeeeee"))))
 '(org-level-1 ((t (:foreground "#5faf5f" :height 1.5))))
 '(org-level-2 ((t (:foreground "#D8553B" :height 1.3))))
 '(org-level-3 ((t (:foreground "#5fafd7" :height 1.2))))
 '(org-level-4 ((t (:foreground "#d78700" :height 1.2)))))
)
